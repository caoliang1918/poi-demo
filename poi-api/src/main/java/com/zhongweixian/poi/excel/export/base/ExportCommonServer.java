package com.zhongweixian.poi.excel.export.base;

import com.zhongweixian.poi.excel.annotation.Excel;
import com.zhongweixian.poi.excel.annotation.ExcelCollection;
import com.zhongweixian.poi.excel.annotation.ExcelEntity;
import com.zhongweixian.poi.excel.entity.ExportParams;
import com.zhongweixian.poi.excel.entity.params.ExcelExportEntity;
import com.zhongweixian.poi.excel.entity.vo.PoiBaseConstants;
...
import com.zhongweixian.poi.excel.handler.inter.IExcelDataHandler;
import com.zhongweixian.poi.excel.util.PoiPublicUtil;
import com.zhongweixian.poi.excel.util.PoiReflectorUtil;
...
public class ExportCommonServer {
    ...
    private Object numFormatValue(Object value, ExcelExportEntity entity) {
        ...
        if (!NumberUtils.isNumber(value.toString())) {
            logger.error("Date Format Exception:" + value);
            return null;
        }
